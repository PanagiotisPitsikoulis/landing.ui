...
- [#2541](https://github.com/PanagiotisPitsikoulis/landing.ui/pull/2541) [`26a3a7d2c`](https://github.com/PanagiotisPitsikoulis/landing.ui/commit/26a3a7d2c6433c3bdd2aa6e6200077a57fdd94f4) Thanks [@withden](https://github.com/withden)! - Removing the `children` type from BadgeProps, as the already extended UseBadgeProps has a `children` prop.
