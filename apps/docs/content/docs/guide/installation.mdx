...
Or you can add the main library `@landing-ui/react` by running the following command:
...
<PackageManagers
  commands={{
    npm: "npm install @landing-ui/react framer-motion",
    yarn: "yarn add @landing-ui/react framer-motion",
    pnpm: "pnpm add @landing-ui/react framer-motion",
    bun: "bun add @landing-ui/react framer-motion"
  }}
/>
...
```bash
public-hoist-pattern[]=*@landing-ui/*
```
...
```js {9,14-15}
// tailwind.config.js
const {nextui} = require("@landing-ui/react");
...
<PackageManagers
  commands={{
    npm: "npm install @landing-ui/theme @landing-ui/system framer-motion",
    yarn: "yarn add @landing-ui/theme @landing-ui/system framer-motion",
    pnpm: "pnpm add @landing-ui/theme @landing-ui/system framer-motion",
    bun: "bun add @landing-ui/theme @landing-ui/system framer-motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @landing-ui/button",
    yarn: "yarn add @landing-ui/button",
    pnpm: "pnpm add @landing-ui/button",
    bun: "bun add @landing-ui/button"
  }}
/>
...
```js {8,10,16}
// tailwind.config.js
const {nextui} = require("@landing-ui/theme");

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    // single component styles
    "./node_modules/@landing-ui/theme/dist/components/button.js",
    // or you can use a glob pattern (multiple component styles)
    './node_modules/@landing-ui/theme/dist/components/(button|snippet|code|input).js'
  ],
  theme: {
    extend: {},
  },
