...
<NextImage
  priority
  src="https://landing-ui.vercel.app/nextui-banner.png"
  quality={100}
  width={700}
  height={350}
  alt="NextUI banner"
...
PRs on NextUI are always welcome, please see our [contribution guidelines](https://github.com/PanagiotisPitsikoulis/landing.ui/blob/main/CONTRIBUTING.md) to learn how you can contribute to this project.
