...
Required min version: @landing-ui/theme>=2.1.0, tailwindcss>=3.4.0
╭───────────────────── PeerDependencies ─────────────────────╮
...
│   Package                    │   Version              │   Status    │   Docs                                              │
│───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────│
│   @landing-ui/autocomplete   │   2.0.10 🚀latest      │   newPost   │   https://landing-ui.vercel.app/docs/components/autocomplete   │
...
For updates and source code, visit the [GitHub Repository](https://github.com/PanagiotisPitsikoulis/landing.ui-cli).
