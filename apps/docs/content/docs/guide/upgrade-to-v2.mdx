...
<PackageManagers
  commands={{
    npm: 'npm i @landing-ui/react framer-motion',
...
> **Important 🚨**: Note that you need to import the component from the individual package, not the from `@landing-ui/react`. 
...
<Blockquote
 color="default"
>
  Please visit the <Link href="https://github.com/PanagiotisPitsikoulis/landing.ui/releases/tag/v2.0.0" showAnchorIcon isExternal>Release Notes</Link> for more information about the new features and breaking changes.
</Blockquote>
