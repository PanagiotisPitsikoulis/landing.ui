...
In addition, NextUI components support help text, which associates additional context with a field such as a **description**
...
NextUI supports errors from schema validation libraries like [Zod](https://zod.dev/).
...
import {Button, Input, Label} from "@landing-ui/react";
...
In most cases, the built-in validation features of NextUI are sufficient. However, if you're building more complex forms or integrating NextUI components into an existing form, you can use a form library like [React Hook Form](https://react-hook-form.com/) or [Formik](https://formik.org/).
...
> For more information about forms in NextUI, visit the [React Aria Forms Guide](https://react-spectrum.adobe.com/react-aria/forms.html).
