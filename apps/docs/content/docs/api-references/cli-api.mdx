...
Adding the required dependencies: @landing-ui/button

pnpm add @landing-ui/button
Packages: +1
+
...
╭───────────────────────── Component ─────────────────────────╮
│  @landing-ui/button              ^2.0.11  ->  ^2.0.31       │
╰─────────────────────────────────────────────────────────────╯

Required min version: @landing-ui/theme>=2.1.0, tailwindcss>=3.4.0, react>=18.3.1, react-dom>=18.3.1
╭───────────────────── PeerDependencies ─────────────────────╮
│  @landing-ui/theme               2.0.1    ->  2.1.0        │
...
pnpm add @landing-ui/button@2.0.31 @landing-ui/theme@2.1.0 tailwindcss@3.4.0 react@18.3.1 react-dom@18.3.1

dependencies:
- @landing-ui/theme 2.0.1
+ @landing-ui/theme 2.1.0 (2.2.3 is available)
+ react 18.3.1
+ react-dom 18.3.1
...
│──────────────────────────────────────────────────────────────────────────────────────────────────────────────│
│   @landing-ui/button   │   2.0.27 🚀latest      │   stable   │   https://landing-ui.vercel.app/docs/components/button   │
╰──────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
? Confirm removal of these components: › - Use arrow-keys. Return to submit.
❯   Yes
    No

pnpm remove  @landing-ui/button
Already up to date
...
✅ Successfully removed the specified NextUI components: @landing-ui/button
```
...
│   Package                    │   Version              │   Status    │   Docs                                              │
│───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────│
│   @landing-ui/autocomplete   │   2.0.10 🚀latest      │   stable    │   https://landing-ui.vercel.app/docs/components/autocomplete   │
│   @landing-ui/badge          │   2.0.24 🚀latest      │   stable    │   https://landing-ui.vercel.app/docs/components/badge          │
│   @landing-ui/button         │   2.0.27 🚀latest      │   stable    │   https://landing-ui.vercel.app/docs/components/button         │
│   @landing-ui/chip           │   2.0.25 🚀latest      │   stable    │   https://landing-ui.vercel.app/docs/components/chip           │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
```
...
Missing tailwind.config.(j|t)s file. To set up, visit: https://landing-ui.vercel.app/docs/guide/installation#tailwind-css-setup
```
