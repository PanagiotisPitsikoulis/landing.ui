...
you can use the [@landing-ui/use-theme](https://github.com/PanagiotisPitsikoulis/landing.ui/tree/canary/packages/hooks/use-theme) hook to switch between themes.

<Steps> 

### Install @landing-ui/use-theme

Install `@landing-ui/use-theme` in your project.

<PackageManagers
  commands={{
    npm: 'npm install @landing-ui/use-theme',
    yarn: 'yarn add @landing-ui/use-theme',
    pnpm: 'pnpm add @landing-ui/use-theme',
  }}
/> 
