...
reference. Go [here](https://github.com/PanagiotisPitsikoulis/landing.ui/blob/feat/v2/packages/core/theme/src/components/button.ts) to view the styles source code.
...
```tsx
// MyButton.tsx
import {extendVariants, Button} from "@landing-ui/react";
...
reference. Go [here](https://github.com/PanagiotisPitsikoulis/landing.ui/blob/feat/v2/packages/core/theme/src/components/input.ts) to view the styles source code.
...
```tsx
// MyInput.tsx
import {extendVariants, Input} from "@landing-ui/react";
