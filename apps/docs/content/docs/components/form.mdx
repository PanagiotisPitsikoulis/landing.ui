...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/form",
    yarn: "yarn add @landing-ui/form",
    pnpm: "pnpm add @landing-ui/form",
    bun: "bun add @landing-ui/form",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Form} from "@landing-ui/react";',
    individual: 'import {Form} from "@landing-ui/form";',
  }}
/>
...
```tsx
import {Form, Button} from '@landing-ui/react';
