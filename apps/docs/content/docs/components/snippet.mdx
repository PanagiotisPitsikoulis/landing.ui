...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/snippet",
    yarn: "yarn add @landing-ui/snippet",
    pnpm: "pnpm add @landing-ui/snippet",
    bun: "bun add @landing-ui/snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@landing-ui/react";',
    individual: 'import {Snippet} from "@landing-ui/snippet";',
  }}
/>
