...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/code",
    yarn: "yarn add @landing-ui/code",
    pnpm: "pnpm add @landing-ui/code",
    bun: "bun add @landing-ui/code"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Code} from "@landing-ui/react";',
    individual: 'import {Code} from "@landing-ui/code";',
  }}
/>
