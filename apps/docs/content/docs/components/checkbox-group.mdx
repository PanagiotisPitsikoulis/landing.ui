...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/checkbox",
    yarn: "yarn add @landing-ui/checkbox",
    pnpm: "pnpm add @landing-ui/checkbox",
    bun: "bun add @landing-ui/checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@landing-ui/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@landing-ui/checkbox";',
  }}
/>
