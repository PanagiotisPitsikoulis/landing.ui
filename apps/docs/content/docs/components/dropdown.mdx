...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/dropdown",
    yarn: "yarn add @landing-ui/dropdown",
    pnpm: "pnpm add @landing-ui/dropdown",
    bun: "bun add @landing-ui/dropdown"
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@landing-ui/react";
