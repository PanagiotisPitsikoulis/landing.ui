...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/pagination",
    yarn: "yarn add @landing-ui/pagination",
    pnpm: "pnpm add @landing-ui/pagination",
    bun: "bun add @landing-ui/pagination"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@landing-ui/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@landing-ui/pagination";',
  }}
/>
