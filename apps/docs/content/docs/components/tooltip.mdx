...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/tooltip",
    yarn: "yarn add @landing-ui/tooltip",
    pnpm: "pnpm add @landing-ui/tooltip",
    bun: "bun add @landing-ui/tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@landing-ui/react";',
    individual: 'import {Tooltip} from "@landing-ui/tooltip";',
  }}
/>

> For individual installation, please note that you should add `./node_modules/@landing-ui/theme/dist/components/popover.js` to your `tailwind.config.js` file instead since tooltip reuses popover styles.
