...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/image",
    yarn: "yarn add @landing-ui/image",
    pnpm: "pnpm add @landing-ui/image",
    bun: "bun add @landing-ui/image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@landing-ui/react";',
    individual: 'import {Image} from "@landing-ui/image";',
  }}
/>
