...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/progress",
    yarn: "yarn add @landing-ui/progress",
    pnpm: "pnpm add @landing-ui/progress",
    bun: "bun add @landing-ui/progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@landing-ui/react";',
    individual: 'import {CircularProgress} from "@landing-ui/progress";',
  }}
/>
