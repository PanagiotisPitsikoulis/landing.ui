...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/kbd",
    yarn: "yarn add @landing-ui/kbd",
    pnpm: "pnpm add @landing-ui/kbd",
    bun: "bun add @landing-ui/kbd"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Kbd} from "@landing-ui/react";',
    individual: 'import {Kbd} from "@landing-ui/kbd";',
  }}
/>
