...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/skeleton",
    yarn: "yarn add @landing-ui/skeleton",
    pnpm: "pnpm add @landing-ui/skeleton",
    bun: "bun add @landing-ui/skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@landing-ui/react";',
    individual: 'import {Skeleton} from "@landing-ui/skeleton";',
  }}
/>
