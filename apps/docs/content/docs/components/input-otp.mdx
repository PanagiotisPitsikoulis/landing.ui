...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/input-otp",
    yarn: "yarn add @landing-ui/input-otp",
    pnpm: "pnpm add @landing-ui/input-otp",
    bun: "bun add @landing-ui/input-otp",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {InputOtp} from "@landing-ui/react";',
    individual: 'import {InputOtp} from "@landing-ui/input-otp";',
  }}
/>
