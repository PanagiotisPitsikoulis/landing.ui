...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/spacer",
    yarn: "yarn add @landing-ui/spacer",
    pnpm: "pnpm add @landing-ui/spacer",
    bun: "bun add @landing-ui/spacer"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spacer} from "@landing-ui/react";',
    individual: 'import {Spacer} from "@landing-ui/spacer";',
  }}
/>
