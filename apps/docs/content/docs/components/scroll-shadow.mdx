...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/scroll-shadow",
    yarn: "yarn add @landing-ui/scroll-shadow",
    pnpm: "pnpm add @landing-ui/scroll-shadow",
    bun: "bun add @landing-ui/scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@landing-ui/react";',
    individual: 'import {ScrollShadow} from "@landing-ui/scroll-shadow";',
  }}
/>
