...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/link",
    yarn: "yarn add @landing-ui/link",
    pnpm: "pnpm add @landing-ui/link",
    bun: "bun add @landing-ui/link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@landing-ui/react";',
    individual: 'import {Link} from "@landing-ui/link";',
  }}
/>
