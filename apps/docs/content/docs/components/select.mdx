...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/select",
    yarn: "yarn add @landing-ui/select",
    pnpm: "pnpm add @landing-ui/select",
    bun: "bun add @landing-ui/select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@landing-ui/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@landing-ui/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @landing-ui/use-infinite-scroll",
    yarn: "yarn add @landing-ui/use-infinite-scroll",
    pnpm: "pnpm add @landing-ui/use-infinite-scroll",
  }}
/>
