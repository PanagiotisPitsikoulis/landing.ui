...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/popover",
    yarn: "yarn add @landing-ui/popover",
    pnpm: "pnpm add @landing-ui/popover",
    bun: "bun add @landing-ui/popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@landing-ui/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@landing-ui/popover";',
  }}
/>
