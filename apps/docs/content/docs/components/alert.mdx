...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/alert",
    yarn: "yarn add @landing-ui/alert",
    pnpm: "pnpm add @landing-ui/alert",
    bun: "bun add @landing-ui/alert",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Alert} from "@landing-ui/react";',
    individual: 'import {Alert} from "@landing-ui/alert";',
  }}
/>
