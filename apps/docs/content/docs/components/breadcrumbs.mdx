...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/breadcrumbs",
    yarn: "yarn add @landing-ui/breadcrumbs",
    pnpm: "pnpm add @landing-ui/breadcrumbs",
    bun: "bun add @landing-ui/breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@landing-ui/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@landing-ui/breadcrumbs";',
  }}
/>
