...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/tabs",
    yarn: "yarn add @landing-ui/tabs",
    pnpm: "pnpm add @landing-ui/tabs",
    bun: "bun add @landing-ui/tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@landing-ui/react";',
    individual: 'import {Tabs, Tab} from "@landing-ui/tabs";',
  }}
/>
