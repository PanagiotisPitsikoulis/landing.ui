...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/card",
    yarn: "yarn add @landing-ui/card",
    pnpm: "pnpm add @landing-ui/card",
    bun: "bun add @landing-ui/card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@landing-ui/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@landing-ui/card";',
  }}
/>
