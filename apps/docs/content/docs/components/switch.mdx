...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/switch",
    yarn: "yarn add @landing-ui/switch",
    pnpm: "pnpm add @landing-ui/switch",
    bun: "bun add @landing-ui/switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@landing-ui/react";',
    individual: 'import {Switch} from "@landing-ui/switch";',
  }}
/>
