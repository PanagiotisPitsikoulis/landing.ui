...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/input",
    yarn: "yarn add @landing-ui/input",
    pnpm: "pnpm add @landing-ui/input",
    bun: "bun add @landing-ui/input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@landing-ui/react";',
    individual: 'import {Textarea} from "@landing-ui/input";',
  }}
/>
