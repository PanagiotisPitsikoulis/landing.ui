...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/table",
    yarn: "yarn add @landing-ui/table",
    pnpm: "pnpm add @landing-ui/table",
    bun: "bun add @landing-ui/table"
  }}
/>
...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@landing-ui/react";
...
[@landing-ui/use-infinite-scroll](https://www.npmjs.com/package/@landing-ui/use-infinite-scroll) hook.

<PackageManagers
  commands={{
    npm: "npm install @react-stately/data @landing-ui/use-infinite-scroll",
    yarn: "yarn add @react-stately/data @landing-ui/use-infinite-scroll",
    pnpm: "pnpm add @react-stately/data @landing-ui/use-infinite-scroll",
    bun: "bun add @react-stately/data @landing-ui/use-infinite-scroll",
  }}
/>
