...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/autocomplete",
    yarn: "yarn add @landing-ui/autocomplete",
    pnpm: "pnpm add @landing-ui/autocomplete",
    bun: "bun add @landing-ui/autocomplete",
  }}
/>
