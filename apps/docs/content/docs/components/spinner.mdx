...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/spinner",
    yarn: "yarn add @landing-ui/spinner",
    pnpm: "pnpm add @landing-ui/spinner",
    bun: "bun add @landing-ui/spinner"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spinner} from "@landing-ui/react";',
    individual: 'import {Spinner} from "@landing-ui/spinner";',
  }}
/>
