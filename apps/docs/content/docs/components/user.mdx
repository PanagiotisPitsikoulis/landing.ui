...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/user",
    yarn: "yarn add @landing-ui/user",
    pnpm: "pnpm add @landing-ui/user",
    bun: "bun add @landing-ui/user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@landing-ui/react";',
    individual: 'import {User} from "@landing-ui/user";',
  }}
/>
