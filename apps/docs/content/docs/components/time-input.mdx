...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/date-input",
    yarn: "yarn add @landing-ui/date-input",
    pnpm: "pnpm add @landing-ui/date-input",
    bun: "bun add @landing-ui/date-input"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {TimeInput} from "@landing-ui/react";',
    individual: 'import {TimeInput} from "@landing-ui/date-input";',
  }}
/>
