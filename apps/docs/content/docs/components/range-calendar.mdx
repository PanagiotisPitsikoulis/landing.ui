...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/calendar",
    yarn: "yarn add @landing-ui/calendar",
    pnpm: "pnpm add @landing-ui/calendar",
    bun: "bun add @landing-ui/calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@landing-ui/react";',
    individual: 'import {RangeCalendar} from "@landing-ui/calendar";',
  }}
/>
