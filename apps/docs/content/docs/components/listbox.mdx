...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/listbox",
    yarn: "yarn add @landing-ui/listbox",
    pnpm: "pnpm add @landing-ui/listbox",
    bun: "bun add @landing-ui/listbox"
  }}
/>
