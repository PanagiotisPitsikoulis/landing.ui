...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/accordion",
    yarn: "yarn add @landing-ui/accordion",
    pnpm: "pnpm add @landing-ui/accordion",
    bun: "bun add @landing-ui/accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@landing-ui/react";',
    individual: 'import {Accordion, AccordionItem} from "@landing-ui/accordion";',
  }}
/>
