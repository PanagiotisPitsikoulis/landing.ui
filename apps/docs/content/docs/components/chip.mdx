...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/chip",
    yarn: "yarn add @landing-ui/chip",
    pnpm: "pnpm add @landing-ui/chip",
    bun: "bun add @landing-ui/chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@landing-ui/react";',
    individual: 'import {Chip} from "@landing-ui/chip";',
  }}
/>
