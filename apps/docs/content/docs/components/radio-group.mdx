...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/radio",
    yarn: "yarn add @landing-ui/radio",
    pnpm: "pnpm add @landing-ui/radio",
    bun: "bun add @landing-ui/radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@landing-ui/react";',
    individual: 'import {RadioGroup, Radio} from "@landing-ui/radio";',
  }}
/>
