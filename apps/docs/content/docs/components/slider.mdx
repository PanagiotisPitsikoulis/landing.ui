...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/slider",
    yarn: "yarn add @landing-ui/slider",
    pnpm: "pnpm add @landing-ui/slider",
    bun: "bun add @landing-ui/slider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Slider} from "@landing-ui/react";',
    individual: 'import {Slider} from "@landing-ui/slider";',
  }}
/>
