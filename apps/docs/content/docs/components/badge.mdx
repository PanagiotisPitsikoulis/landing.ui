...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/badge",
    yarn: "yarn add @landing-ui/badge",
    pnpm: "pnpm add @landing-ui/badge",
    bun: "bun add @landing-ui/badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@landing-ui/react";',
    individual: 'import {Badge} from "@landing-ui/badge";',
  }}
/>
