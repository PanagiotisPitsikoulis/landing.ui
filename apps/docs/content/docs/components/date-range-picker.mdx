...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/date-picker",
    yarn: "yarn add @landing-ui/date-picker",
    pnpm: "pnpm add @landing-ui/date-picker",
    bun: "bun add @landing-ui/date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@landing-ui/react";',
    individual: 'import {DateRangePicker} from "@landing-ui/date-picker";',
  }}
/>
