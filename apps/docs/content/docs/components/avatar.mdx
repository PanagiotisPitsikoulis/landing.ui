...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @landing-ui/avatar",
    yarn: "yarn add @landing-ui/avatar",
    pnpm: "pnpm add @landing-ui/avatar",
    bun: "bun add @landing-ui/avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@landing-ui/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@landing-ui/avatar";',
  }}
/>
